...
class GPT2SentimentClassifier(torch.nn.Module):
    ...
    def __init__(self, config):
        ...
        ### TODO: Create any instance variables you need to classify the sentiment of GPT2 embeddings.
        ### YOUR CODE HERE
    ...
    def forward(self, input_ids, attention_mask, training=True):
        ...
        def eval(embed):
            ...
            last_hidden_state = self.gpt.final_layer_norm(sequence_output)
            logits = self.classifier(self.dropout(last_hidden_state[:, -1, :]))
            return logits
        ...
        if training:
            ...
            # Apply smart loss
            loss = self.config.smart_weight * smart_loss_fn(embed, logits)
