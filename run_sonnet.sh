...
python sonnet_generation_ext.py -e $epochs --temperature 0.5 --lr "1e-4"

echo -e "${YELLOW}Running experiment 3: Standard Model${RESET} with Temperature 0.8"
python sonnet_generation_ext.py -e $epochs --temperature 0.8 --lr "1e-4"

echo -e "${YELLOW}Running experiment 4: Standard Model${RESET} with Temperature 1.0"
python sonnet_generation_ext.py -e $epochs --temperature 1.0 --lr "1e-4"

echo -e "${YELLOW}Running experiment 5: Standard Model${RESET} with Learning Rate 1e-3"
python sonnet_generation_ext.py -e $epochs --lr "1e-4"

echo -e "${YELLOW}Running experiment 6: Standard Model${RESET} with Weight Decay 1e-3"
python sonnet_generation_ext.py -e $epochs --weight_decay "1e-3" --lr "1e-4"

echo -e "${YELLOW}Running experiment 7: Standard Model${RESET} with Weight Decay 1e-2"
python sonnet_generation_ext.py -e $epochs --weight_decay "1e-2" --lr "1e-4"

echo -e "${YELLOW}Running experiment 8: Standard Model${RESET} with Weight Decay 1e-4"
python sonnet_generation_ext.py -e $epochs --weight_decay "1e-4" --lr "1e-4"

echo -e "${YELLOW}Running experiment 1: Standard Model${RESET}"
python sonnet_generation_ext.py -e $epochs --change_dropout --dropout 0.05 --lr "1e-4"


echo -e "${YELLOW}Running experiment 1: Standard Model${RESET}"
python sonnet_generation_ext.py -e $epochs --change_dropout --dropout 0.15 --lr "1e-4"

echo -e "${YELLOW}Running experiment 1: Standard Model${RESET}"
python sonnet_generation_ext.py -e $epochs --change_dropout --dropout 0.2 --lr "1e-4"
